...
public abstract class MessagingForwarder extends ListActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        final String[] inboxTypeClasses = new String[]{
                "com.stdserver.msms.ui.MessagingSmsInbox",
                "com.stdserver.msms.ui.MessagingMmsInbox",
                "com.stdserver.msms.ui.MessagingSentSms",
        };
...
//                forwardAllClicked();
                Toast.makeText(this, "The forwarding menu ", Toast.LENGTH_SHORT).show();
                return true;
            default:
